...
13F의 저장소 격리 테스트 C# 파일 두 개에 대응하는 Unity `.meta` 파일이 이전 커밋에서 빠져 있던 것을
확인해 별도 보정 커밋으로 포함했다. 두 GUID는 각각 `88efdaa52ab424121999fef87dcaeb05`와
`170a6c4d414894dc382eb4c560c9dd16`이며, `Assets`의 다른 `.meta`와 충돌하지 않는다.
